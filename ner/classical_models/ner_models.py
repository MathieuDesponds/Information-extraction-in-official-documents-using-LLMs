...
def get_results(dataset, with_save = False, path_to_save= lambda dataset : f'./ner/saves/results/{dataset}/test_full.pkl'):
    ...
    for i in tqdm(range(len(dataset))):
        ...
        flair_ontonote_base.extend(flair_ontonote_base_entities)

        # flair_ontonote_large_entities = extract_entities_flair(dataset[i]['text'], tagger_flair_ontonote_large)
        # flair_ontonote_large.extend(flair_ontonote_large_entities)
