...
precision_ner = {'PER' : 'Person entities are all the names you can find in the text. That can be celebrities, historical figures, fictional characters or just random names.', 
                 ...
                 'MISC': 'Miscellaneous entities are all events or, names and entities that are specific but do not have a well-defined category and do not fit in person, organization or location entities)'}
